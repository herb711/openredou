export const dict = {
  ...
  "desktop.updater.none.message": "Du bruker allerede den nyeste versjonen av OpenRedou",
  ...
  "desktop.updater.downloaded.prompt":
    "Versjon {{version}} av OpenRedou er lastet ned. Vil du installere den og starte på nytt?",
