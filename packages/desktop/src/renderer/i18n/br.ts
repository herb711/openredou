export const dict = {
  ...
  "desktop.updater.none.message": "Você já está usando a versão mais recente do OpenRedou",
  ...
  "desktop.updater.downloaded.prompt":
    "A versão {{version}} do OpenRedou foi baixada. Você gostaria de instalá-la e reiniciar?",
