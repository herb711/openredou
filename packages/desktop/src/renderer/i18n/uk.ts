export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію OpenRedou",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} OpenRedou завантажено. Бажаєте встановити її та перезапустити?",
