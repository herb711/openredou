export const dict = {
  ...
  "desktop.updater.none.message": "Korzystasz już z najnowszej wersji OpenRedou",
  ...
  "desktop.updater.downloaded.prompt":
    "Pobrano wersję {{version}} OpenRedou. Czy chcesz ją zainstalować i uruchomić ponownie?",
