export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'OpenRedou",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'OpenRedou a été téléchargée. Voulez-vous l'installer et redémarrer ?",
