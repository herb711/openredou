...
export function DebugBarPanel() {
  ...
  return (
    <div class="grid grid-cols-5 gap-px font-mono text-text-strong">
      <Cell
...
export function DebugBar() {
  ...
  return (
    <aside
      ...
      class="pointer-events-auto fixed bottom-3 right-3 z-50 w-[308px] max-w-[calc(100vw-1.5rem)] overflow-hidden rounded-xl border border-border-base bg-surface-raised-stronger-non-alpha p-0.5 shadow-[var(--shadow-lg-border-base)] sm:bottom-4 sm:right-4 sm:w-[324px]"
    >
      <DebugBarPanel />
    </aside>
  )
