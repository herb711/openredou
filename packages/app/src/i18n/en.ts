export const dict = {
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in OpenRedou.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in OpenRedou.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in OpenRedou.",
  ...
  "dialog.server.description": "Switch which OpenRedou server this app connects to.",
  ...
  "toast.update.description": "A new version of OpenRedou ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the OpenRedou team",
  ...
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, OpenRedou does not support MCP authentication yet.',
  ...
  "settings.tab.archived": "Archived",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL integration",
  "settings.desktop.wsl.description": "Run the OpenRedou server inside WSL on Windows.",

  "settings.archived.title": "Archived",
  "settings.archived.projects.title": "Closed projects",
  "settings.archived.projects.empty": "No closed projects",
  "settings.archived.sessions.title": "Archived conversations",
  "settings.archived.sessions.empty": "No archived conversations",
  "settings.archived.action.restore": "Restore",
  "settings.archived.action.deleteForever": "Delete completely",
  "settings.archived.action.deleteSelected": "Delete selected ({{count}})",
  "settings.archived.action.confirmDelete": "Confirm delete",
  "settings.archived.action.selectAll": "Select all",
  "settings.archived.project.restore.success": "{{name}} restored",
  "settings.archived.project.delete.success": "{{name}} deleted",
  "settings.archived.project.delete.selected.success": "{{count}} projects deleted",
  "settings.archived.project.delete.selected.failed": "{{count}} projects failed to delete",
  "settings.archived.project.delete.failed": "Failed to delete project",
  "settings.archived.project.delete.confirm.title": "Delete project completely",
  "settings.archived.project.delete.confirm.description":
    "Delete {{name}} and all saved OpenRedou sessions for this project. Local project files are not deleted.",
  "settings.archived.session.restore.success": "{{title}} restored",
  "settings.archived.session.delete.success": "{{title}} deleted",
  "settings.archived.session.delete.selected.success": "{{count}} conversations deleted",
  "settings.archived.session.delete.selected.failed": "{{count}} conversations failed to delete",
  "settings.archived.session.restore.failed": "Failed to restore conversation",
  "settings.archived.session.delete.failed": "Failed to delete conversation",
  "settings.archived.session.delete.confirm.title": "Delete conversation completely",
  "settings.archived.session.delete.confirm.description": "Delete {{title}} permanently. This cannot be undone.",
  ...
  "settings.general.row.language.description": "Change the display language for OpenRedou",
  ...
  "settings.general.row.appearance.description": "Customise how OpenRedou looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether OpenRedou follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how OpenRedou is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when OpenRedou launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of OpenRedou.",
  ...
  "settings.plugins.description": "Configure plugins, skills, and MCP servers.",
  "settings.plugins.tab.plugins": "Plugins",
  "settings.plugins.tab.skills": "Skills",
  "settings.plugins.tab.mcp": "MCP",
  "settings.plugins.section.configured": "Configured plugins",
  "settings.plugins.section.add": "Add plugin",
  "settings.plugins.section.edit": "Edit plugin",
  "settings.plugins.configured.empty": "No plugins configured.",
  "settings.plugins.form.source.title": "Source",
  "settings.plugins.form.source.description": "NPM package, local file path, or URL.",
  "settings.plugins.form.source.placeholder": "@opencode-ai/plugin-example",
  "settings.plugins.form.options.title": "Options",
  "settings.plugins.form.options.description": "Optional plugin options as key=value lines.",
  "settings.plugins.form.options.placeholder": "name=value",
  "settings.plugins.validation.source": "Enter a plugin source",
  "settings.plugins.toast.saved.title": "Plugin settings saved",
  "settings.plugins.toast.failed.title": "Failed to save plugin settings",
  "settings.skills.section.sources": "Skill sources",
  "settings.skills.section.available": "Available skills",
  "settings.skills.paths.title": "Local folders",
  "settings.skills.paths.description": "Folders that contain skill directories.",
  "settings.skills.urls.title": "Remote indexes",
  "settings.skills.urls.description": "Skill indexes loaded from a URL.",
  "settings.skills.addPath.placeholder": "Path to a skill folder",
  "settings.skills.addUrl.placeholder": "https://example.com/skills.json",
  "settings.skills.empty.paths": "No local skill folders configured.",
  "settings.skills.empty.urls": "No remote skill indexes configured.",
  "settings.skills.empty.available": "No skills found for this project.",
  "settings.skills.currentProjectRequired": "Open a project to inspect available skills.",
  "settings.skills.search.placeholder": "Search skills",
  "settings.skills.toast.saved.title": "Skill settings saved",
  "settings.skills.toast.failed.title": "Failed to save skill settings",
  ...
  "settings.mcp.description": "Configure model context protocol servers.",
  "settings.mcp.section.servers": "MCP servers",
  "settings.mcp.section.add": "Add MCP server",
  "settings.mcp.section.edit": "Edit MCP server",
  "settings.mcp.form.name": "Name",
  "settings.mcp.form.name.description": "Unique server name used in config and status views.",
  "settings.mcp.form.name.placeholder": "filesystem",
  "settings.mcp.form.type": "Type",
  "settings.mcp.form.type.description": "Run a local command or connect to a remote endpoint.",
  "settings.mcp.form.command": "Command",
  "settings.mcp.form.command.description": "Command and arguments separated by spaces.",
  "settings.mcp.form.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem .",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.url.description": "Remote MCP server endpoint.",
  "settings.mcp.form.url.placeholder": "https://example.com/mcp",
  "settings.mcp.form.timeout": "Timeout",
  "settings.mcp.form.timeout.description": "Optional request timeout in milliseconds.",
  "settings.mcp.form.timeout.placeholder": "30000",
  "settings.mcp.form.environment": "Environment",
  "settings.mcp.form.environment.description": "Optional environment variables as key=value lines.",
  "settings.mcp.form.minimaxApiKey": "MiniMax API Key",
  "settings.mcp.form.minimaxApiKey.description": "Stored as MINIMAX_API_KEY for local MiniMax MCP servers when saving.",
  "settings.mcp.form.minimaxApiKey.placeholder": "sk-...",
  "settings.mcp.form.headers": "Headers",
  "settings.mcp.form.headers.description": "Optional HTTP headers as key=value lines.",
  "settings.mcp.form.pairs.placeholder": "NAME=value",
  "settings.mcp.form.oauth": "OAuth discovery",
  "settings.mcp.form.oauth.description": "Allow remote servers to auto-detect OAuth.",
  "settings.mcp.form.enabled": "Enabled",
  "settings.mcp.form.enabled.description": "Start or expose this server by default.",
  "settings.mcp.validation.name": "Enter an MCP server name",
  "settings.mcp.validation.command": "Enter a local command",
  "settings.mcp.validation.url": "Enter a remote MCP URL",
  "settings.mcp.validation.timeout": "Timeout must be a positive number",
  "settings.mcp.toast.saved.title": "MCP settings saved",
  ...
  "settings.mcp.test.title": "MCP tests",
  "settings.mcp.test.idle": "Run a connection probe to list tools.",
  "settings.mcp.test.tools": "{{count}} tools detected",
  "settings.mcp.test.connection": "Probe",
  "settings.mcp.test.smoke": "API smoke",
  "settings.mcp.test.smoke.ok": "API key smoke test passed.",
  "settings.mcp.test.smoke.failed": "API key smoke test failed: {{error}}",
  "settings.mcp.test.toast.failed.title": "MCP test failed",
