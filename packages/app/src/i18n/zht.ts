...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 OpenRedou 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 OpenRedou 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 OpenRedou 中使用 {{provider}} 模型。",
  ...
  "dialog.server.description": "切換此應用程式連線的 OpenRedou 伺服器。",
  ...
  "toast.update.description": "OpenRedou 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 OpenRedou 團隊",
  ...
  "error.chain.mcpFailed": 'MCP 伺服器 "{{name}}" 啟動失敗。注意: OpenRedou 暫不支援 MCP 認證。',
  ...
  "session.rules.global": "全域規則",
  "session.rules.project": "專案規則",
  "session.rules.saved": "規則已儲存",
  ...
  "settings.tab.archived": "已封存",
  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 整合",
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 OpenRedou 伺服器。",

  "settings.archived.title": "已封存",
  "settings.archived.projects.title": "已關閉專案",
  "settings.archived.projects.empty": "沒有已關閉專案",
  "settings.archived.sessions.title": "已封存對話",
  "settings.archived.sessions.empty": "沒有已封存對話",
  "settings.archived.action.restore": "恢復",
  "settings.archived.action.deleteForever": "徹底刪除",
  "settings.archived.action.deleteSelected": "刪除選取（{{count}}）",
  "settings.archived.action.confirmDelete": "確認刪除",
  "settings.archived.action.selectAll": "全選",
  "settings.archived.project.restore.success": "已恢復 {{name}}",
  "settings.archived.project.delete.success": "已刪除 {{name}}",
  "settings.archived.project.delete.selected.success": "已刪除 {{count}} 個專案",
  "settings.archived.project.delete.selected.failed": "{{count}} 個專案刪除失敗",
  "settings.archived.project.delete.failed": "刪除專案失敗",
  "settings.archived.project.delete.confirm.title": "徹底刪除專案",
  "settings.archived.project.delete.confirm.description":
    "刪除 {{name}} 以及 OpenRedou 為這個專案保存的所有工作階段紀錄。本機專案檔案不會被刪除。",
  "settings.archived.session.restore.success": "已恢復 {{title}}",
  "settings.archived.session.delete.success": "已刪除 {{title}}",
  "settings.archived.session.delete.selected.success": "已刪除 {{count}} 個對話",
  "settings.archived.session.delete.selected.failed": "{{count}} 個對話刪除失敗",
  "settings.archived.session.restore.failed": "恢復對話失敗",
  "settings.archived.session.delete.failed": "刪除對話失敗",
  "settings.archived.session.delete.confirm.title": "徹底刪除對話",
  "settings.archived.session.delete.confirm.description": "永久刪除 {{title}}。此操作無法復原。",
  ...
  "settings.general.row.language.description": "變更 OpenRedou 的顯示語言",
  "settings.general.row.appearance.title": "外觀",
  "settings.general.row.appearance.description": "自訂 OpenRedou 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 OpenRedou 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 OpenRedou 的主題。",
  ...
  "settings.updates.row.startup.description": "在 OpenRedou 啟動時自動檢查更新",
  ...
  "settings.updates.toast.latest.description": "你正在使用最新版本的 OpenRedou。",
  ...
  "settings.plugins.description": "設定外掛程式、技能和 MCP 伺服器。",
  "settings.plugins.tab.plugins": "外掛程式",
  "settings.plugins.tab.skills": "技能",
  "settings.plugins.tab.mcp": "MCP",
  "settings.plugins.section.configured": "已設定的外掛程式",
  "settings.plugins.section.add": "新增外掛程式",
  "settings.plugins.section.edit": "編輯外掛程式",
  "settings.plugins.configured.empty": "尚未設定外掛程式。",
  "settings.plugins.form.source.title": "來源",
  "settings.plugins.form.source.description": "NPM 套件、本機檔案路徑或 URL。",
  "settings.plugins.form.source.placeholder": "@opencode-ai/plugin-example",
  "settings.plugins.form.options.title": "選項",
  "settings.plugins.form.options.description": "可選外掛程式參數，每行 key=value。",
  "settings.plugins.form.options.placeholder": "name=value",
  "settings.plugins.validation.source": "請輸入外掛程式來源",
  "settings.plugins.toast.saved.title": "外掛程式設定已儲存",
  "settings.plugins.toast.failed.title": "外掛程式設定儲存失敗",
  "settings.skills.section.sources": "技能來源",
  "settings.skills.section.available": "可用技能",
  "settings.skills.paths.title": "本機資料夾",
  "settings.skills.paths.description": "包含技能目錄的資料夾。",
  "settings.skills.urls.title": "遠端索引",
  "settings.skills.urls.description": "從 URL 載入的技能索引。",
  "settings.skills.addPath.placeholder": "技能資料夾路徑",
  "settings.skills.addUrl.placeholder": "https://example.com/skills.json",
  "settings.skills.empty.paths": "尚未設定本機技能資料夾。",
  "settings.skills.empty.urls": "尚未設定遠端技能索引。",
  "settings.skills.empty.available": "目前專案找不到技能。",
  "settings.skills.currentProjectRequired": "開啟專案後可查看可用技能。",
  "settings.skills.search.placeholder": "搜尋技能",
  "settings.skills.toast.saved.title": "技能設定已儲存",
  "settings.skills.toast.failed.title": "技能設定儲存失敗",
  ...
  "settings.mcp.description": "設定模型上下文協定伺服器。",
  "settings.mcp.section.servers": "MCP 伺服器",
  "settings.mcp.section.add": "新增 MCP 伺服器",
  "settings.mcp.section.edit": "編輯 MCP 伺服器",
  "settings.mcp.form.name": "名稱",
  "settings.mcp.form.name.description": "用於設定和狀態檢視的唯一伺服器名稱。",
  "settings.mcp.form.name.placeholder": "filesystem",
  "settings.mcp.form.type": "類型",
  "settings.mcp.form.type.description": "執行本機命令或連接遠端端點。",
  "settings.mcp.form.command": "命令",
  "settings.mcp.form.command.description": "命令和參數以空格分隔。",
  "settings.mcp.form.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem .",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.url.description": "遠端 MCP 伺服器端點。",
  "settings.mcp.form.url.placeholder": "https://example.com/mcp",
  "settings.mcp.form.timeout": "逾時",
  "settings.mcp.form.timeout.description": "可選請求逾時時間，單位毫秒。",
  "settings.mcp.form.timeout.placeholder": "30000",
  "settings.mcp.form.environment": "環境變數",
  "settings.mcp.form.environment.description": "可選環境變數，每行 key=value。",
  "settings.mcp.form.minimaxApiKey": "MiniMax API Key",
  "settings.mcp.form.minimaxApiKey.description": "儲存時寫入本機 MiniMax MCP 的 MINIMAX_API_KEY。",
  "settings.mcp.form.minimaxApiKey.placeholder": "sk-...",
  "settings.mcp.form.headers": "請求標頭",
  "settings.mcp.form.headers.description": "可選 HTTP 請求標頭，每行 key=value。",
  "settings.mcp.form.pairs.placeholder": "NAME=value",
  "settings.mcp.form.oauth": "OAuth 探索",
  "settings.mcp.form.oauth.description": "允許遠端伺服器自動偵測 OAuth。",
  "settings.mcp.form.enabled": "啟用",
  "settings.mcp.form.enabled.description": "預設啟動或公開此伺服器。",
  "settings.mcp.validation.name": "請輸入 MCP 伺服器名稱",
  "settings.mcp.validation.command": "請輸入本機命令",
  "settings.mcp.validation.url": "請輸入遠端 MCP URL",
  "settings.mcp.validation.timeout": "逾時必須是正數",
  "settings.mcp.toast.saved.title": "MCP 設定已儲存",
  "settings.mcp.toast.failed.title": "MCP 設定儲存失敗",
  "settings.mcp.import.title": "貼上 MiniMax MCP 設定",
  "settings.mcp.import.paste": "設定 JSON",
  "settings.mcp.import.paste.description": "可貼上 MiniMax --agent-config 輸出、完整 mcp JSON 或 OpenCode MCP 片段。",
  "settings.mcp.import.placeholder":
    '{\n  "mcp": {\n    "minimax-bridge": {\n      "type": "local",\n      "command": ["node", ".../dist/index.js"]\n    }\n  }\n}',
  "settings.mcp.import.action": "解析設定",
  "settings.mcp.import.toast.success.title": "MCP 設定已解析",
  "settings.mcp.import.toast.failed.title": "無法解析 MCP 設定",
  "settings.mcp.test.title": "MCP 測試",
  "settings.mcp.test.idle": "執行連線探測以讀取工具列表。",
  "settings.mcp.test.tools": "偵測到 {{count}} 個工具",
  "settings.mcp.test.connection": "連線探測",
  "settings.mcp.test.smoke": "API 冒煙",
  "settings.mcp.test.smoke.ok": "API key 冒煙測試通過。",
  "settings.mcp.test.smoke.failed": "API key 冒煙測試失敗：{{error}}",
  "settings.mcp.test.toast.failed.title": "MCP 測試失敗",
