...
export const dict = {
  ...
  "sidebar.gettingStarted.line1": "OpenRedou 提供免費模型，你可以立即開始使用。",
  ...
  "settings.plugins.form.options.description": "可選外掛程式選項，每行 key=value。",
  ...
  "settings.plugins.toast.failed.title": "儲存外掛程式設定失敗",
  ...
  "settings.skills.empty.available": "目前專案沒有可用技能。",
  "settings.skills.currentProjectRequired": "開啟專案後可檢視可用技能。",
  "settings.skills.search.placeholder": "搜尋技能",
  "settings.skills.toast.saved.title": "技能設定已儲存",
  "settings.skills.toast.failed.title": "儲存技能設定失敗",
  ...
  "settings.mcp.form.name.description": "用於設定與狀態檢視的唯一伺服器名稱。",
  "settings.mcp.form.name.placeholder": "filesystem",
  "settings.mcp.form.type": "類型",
  "settings.mcp.form.type.description": "執行本機命令或連線到遠端端點。",
  "settings.mcp.form.command": "命令",
  "settings.mcp.form.command.description": "命令與參數以空格分隔。",
  ...
  "settings.mcp.form.minimaxApiKey.description": "儲存本機 MiniMax MCP 伺服器時寫入 MINIMAX_API_KEY。",
  "settings.mcp.form.minimaxApiKey.placeholder": "sk-...",
  "settings.mcp.form.headers": "標頭",
  "settings.mcp.form.headers.description": "可選 HTTP 標頭，每行 key=value。",
  ...
  "settings.mcp.toast.failed.title": "儲存 MCP 設定失敗",
  "settings.mcp.import.title": "貼上 MiniMax MCP 設定",
  "settings.mcp.import.paste": "設定 JSON",
  "settings.mcp.import.paste.description": "貼上 MiniMax --agent-config 輸出、完整 mcp JSON 物件或 OpenCode MCP 伺服器片段。",
  ...
  "settings.mcp.test.idle": "執行連線探測以列出工具。",
  "settings.mcp.test.tools": "偵測到 {{count}} 個工具",
  "settings.mcp.test.connection": "探測",
  "settings.mcp.test.smoke": "API 冒煙測試",
