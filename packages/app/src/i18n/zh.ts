...
export const dict = {
  ...
  "provider.connect.apiKey.description":
    "输入你的 {{provider}} API 密钥以连接帐户，并在 OpenRedou 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.code.visit.suffix": " 获取授权码，以连接你的帐户并在 OpenRedou 中使用 {{provider}} 模型。",
  ...
  "settings.plugins.toast.failed.title": "插件设置保存失败",
  ...
  "settings.skills.empty.available": "当前项目未找到技能。",
  ...
  "settings.skills.toast.failed.title": "技能设置保存失败",
  ...
  "settings.mcp.form.minimaxApiKey.description": "保存时写入本地 MiniMax MCP 的 MINIMAX_API_KEY。",
  ...
  "settings.mcp.toast.failed.title": "MCP 设置保存失败",
  ...
  "settings.mcp.test.idle": "运行连接探测以读取工具列表。",
  "settings.mcp.test.tools": "检测到 {{count}} 个工具",
  "settings.mcp.test.connection": "连接探测",
  "settings.mcp.test.smoke": "API 冒烟",
