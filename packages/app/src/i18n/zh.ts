...
export const dict = {
  ...
  "dialog.server.description": "切换此应用连接的 OpenRedou 服务器。",
  ...
  "toast.update.description": "OpenRedou 有新版本 ({{version}}) 可安装。",
  ...
  "error.page.report.prefix": "请将此错误报告给 OpenRedou 团队",
  ...
  "error.chain.mcpFailed": 'MCP 服务器 "{{name}}" 启动失败。注意: OpenRedou 暂不支持 MCP 认证。',
  ...
  "sidebar.gettingStarted.line1": "OpenRedou 提供免费模型，你可以立即开始使用。",
  ...
  "settings.tab.archived": "已归档",

  "settings.desktop.section.wsl": "WSL",
  "settings.desktop.wsl.title": "WSL 集成",
  "settings.desktop.wsl.description": "在 Windows 的 WSL 环境中运行 OpenRedou 服务器。",

  "settings.archived.title": "已归档",
  "settings.archived.projects.title": "已关闭项目",
  "settings.archived.projects.empty": "没有已关闭项目",
  "settings.archived.sessions.title": "已归档对话",
  "settings.archived.sessions.empty": "没有已归档对话",
  "settings.archived.action.restore": "恢复",
  "settings.archived.action.deleteForever": "彻底删除",
  "settings.archived.action.deleteSelected": "删除选中（{{count}}）",
  "settings.archived.action.confirmDelete": "确认删除",
  "settings.archived.action.selectAll": "全选",
  "settings.archived.project.restore.success": "已恢复 {{name}}",
  "settings.archived.project.delete.success": "已删除 {{name}}",
  "settings.archived.project.delete.selected.success": "已删除 {{count}} 个项目",
  "settings.archived.project.delete.selected.failed": "{{count}} 个项目删除失败",
  "settings.archived.project.delete.failed": "删除项目失败",
  "settings.archived.project.delete.confirm.title": "彻底删除项目",
  "settings.archived.project.delete.confirm.description":
    "删除 {{name}} 以及 OpenRedou 为这个项目保存的所有会话记录。本地项目文件不会被删除。",
  "settings.archived.session.restore.success": "已恢复 {{title}}",
  "settings.archived.session.delete.success": "已删除 {{title}}",
  "settings.archived.session.delete.selected.success": "已删除 {{count}} 个对话",
  "settings.archived.session.delete.selected.failed": "{{count}} 个对话删除失败",
  "settings.archived.session.restore.failed": "恢复对话失败",
  "settings.archived.session.delete.failed": "删除对话失败",
  "settings.archived.session.delete.confirm.title": "彻底删除对话",
  "settings.archived.session.delete.confirm.description": "永久删除 {{title}}。此操作无法撤销。",
  ...
  "settings.general.row.language.description": "更改 OpenRedou 的显示语言",
  "settings.general.row.appearance.title": "外观",
  "settings.general.row.appearance.description": "自定义 OpenRedou 在你的设备上的外观",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "选择 OpenRedou 跟随系统、浅色或深色主题",
  "settings.general.row.theme.title": "主题",
  "settings.general.row.theme.description": "自定义 OpenRedou 的主题。",
  ...
  "settings.updates.row.startup.description": "在 OpenRedou 启动时自动检查更新",
  ...
  "settings.plugins.description": "配置插件、技能和 MCP 服务器。",
  "settings.plugins.tab.plugins": "插件",
  "settings.plugins.tab.skills": "技能",
  "settings.plugins.tab.mcp": "MCP",
  "settings.plugins.section.configured": "已配置插件",
  "settings.plugins.section.add": "添加插件",
  "settings.plugins.section.edit": "编辑插件",
  "settings.plugins.configured.empty": "未配置插件。",
  "settings.plugins.form.source.title": "来源",
  "settings.plugins.form.source.description": "NPM 包、本地文件路径或 URL。",
  "settings.plugins.form.source.placeholder": "@opencode-ai/plugin-example",
  "settings.plugins.form.options.title": "选项",
  "settings.plugins.form.options.description": "可选插件参数，每行 key=value。",
  "settings.plugins.form.options.placeholder": "name=value",
  "settings.plugins.validation.source": "请输入插件来源",
  "settings.plugins.toast.saved.title": "插件设置已保存",
  "settings.plugins.toast.failed.title": "保存插件设置失败",
  "settings.skills.section.sources": "技能来源",
  "settings.skills.section.available": "可用技能",
  "settings.skills.paths.title": "本地文件夹",
  "settings.skills.paths.description": "包含技能目录的文件夹。",
  "settings.skills.urls.title": "远程索引",
  "settings.skills.urls.description": "从 URL 加载的技能索引。",
  "settings.skills.addPath.placeholder": "技能文件夹路径",
  "settings.skills.addUrl.placeholder": "https://example.com/skills.json",
  "settings.skills.empty.paths": "未配置本地技能文件夹。",
  "settings.skills.empty.urls": "未配置远程技能索引。",
  "settings.skills.empty.available": "当前项目没有可用技能。",
  "settings.skills.currentProjectRequired": "打开项目后可查看可用技能。",
  "settings.skills.search.placeholder": "搜索技能",
  "settings.skills.toast.saved.title": "技能设置已保存",
  "settings.skills.toast.failed.title": "保存技能设置失败",
  ...
  "settings.mcp.description": "配置模型上下文协议服务器。",
  "settings.mcp.section.servers": "MCP 服务器",
  "settings.mcp.section.add": "添加 MCP 服务器",
  "settings.mcp.section.edit": "编辑 MCP 服务器",
  "settings.mcp.form.name": "名称",
  "settings.mcp.form.name.description": "用于配置和状态视图的唯一服务器名称。",
  "settings.mcp.form.name.placeholder": "filesystem",
  "settings.mcp.form.type": "类型",
  "settings.mcp.form.type.description": "运行本地命令或连接远程端点。",
  "settings.mcp.form.command": "命令",
  "settings.mcp.form.command.description": "命令和参数用空格分隔。",
  "settings.mcp.form.command.placeholder": "npx -y @modelcontextprotocol/server-filesystem .",
  "settings.mcp.form.url": "URL",
  "settings.mcp.form.url.description": "远程 MCP 服务器端点。",
  "settings.mcp.form.url.placeholder": "https://example.com/mcp",
  "settings.mcp.form.timeout": "超时",
  "settings.mcp.form.timeout.description": "可选请求超时时间，单位毫秒。",
  "settings.mcp.form.timeout.placeholder": "30000",
  "settings.mcp.form.environment": "环境变量",
  "settings.mcp.form.environment.description": "可选环境变量，每行 key=value。",
  "settings.mcp.form.minimaxApiKey": "MiniMax API Key",
  "settings.mcp.form.minimaxApiKey.description": "保存本地 MiniMax MCP 服务器时写入 MINIMAX_API_KEY。",
  "settings.mcp.form.minimaxApiKey.placeholder": "sk-...",
  "settings.mcp.form.headers": "请求头",
  "settings.mcp.form.headers.description": "可选 HTTP 请求头，每行 key=value。",
  "settings.mcp.form.pairs.placeholder": "NAME=value",
  "settings.mcp.form.oauth": "OAuth 发现",
  "settings.mcp.form.oauth.description": "允许远程服务器自动检测 OAuth。",
  "settings.mcp.form.enabled": "启用",
  "settings.mcp.form.enabled.description": "默认启动或暴露此服务器。",
  "settings.mcp.validation.name": "请输入 MCP 服务器名称",
  "settings.mcp.validation.command": "请输入本地命令",
  "settings.mcp.validation.url": "请输入远程 MCP URL",
  "settings.mcp.validation.timeout": "超时必须是正数",
  "settings.mcp.toast.saved.title": "MCP 设置已保存",
  "settings.mcp.toast.failed.title": "保存 MCP 设置失败",
  "settings.mcp.import.title": "粘贴 MiniMax MCP 配置",
  "settings.mcp.import.paste": "配置 JSON",
  "settings.mcp.import.paste.description": "粘贴 MiniMax --agent-config 输出、完整 mcp JSON 对象或 OpenCode MCP 服务器片段。",
  ...
  "settings.mcp.test.title": "MCP 测试",
  "settings.mcp.test.idle": "运行连接探测以列出工具。",
  "settings.mcp.test.tools": "检测到 {{count}} 个工具",
  "settings.mcp.test.connection": "探测",
  "settings.mcp.test.smoke": "API 冒烟测试",
  "settings.mcp.test.smoke.ok": "API key 冒烟测试通过。",
  "settings.mcp.test.smoke.failed": "API key 冒烟测试失败：{{error}}",
  "settings.mcp.test.toast.failed.title": "MCP 测试失败",
