...
export const DESKTOP_MENU: DesktopMenu[] = [
  ...
  },
  {
    ...
    label: "Help",
    items: [
      { type: "item", label: "OpenRedou Documentation", href: "https://opencode.ai/docs" },
      ...
      { type: "separator" },
      {
        ...
        href: "https://github.com/herb711/openredou/issues/new?template=feature_request.yml",
      },
      {
        type: "item",
        label: "Report a Bug",
        href: "https://github.com/herb711/openredou/issues/new?template=bug_report.yml",
      },
    ],
  },
]
